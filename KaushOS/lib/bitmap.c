...
/*
    ...
    numbered BIT_IDX.
*/
static INLINE size_t BmElementIndex(IN size_t BitIndex)
{
...
*/
static INLINE ElementType BmBitMask(IN size_t BitIndex)
{
    return ((ElementType)1 << (BitIndex % ELEM_BITS));
}

/* Returns the number of elements required for BIT_CNT bits. */
static inline size_t BmElementCount(IN size_t BitCount)
{
    return DIV_ROUND_UP(BitCount, ELEM_BITS);
}

/* Returns the number of bytes required for BIT_CNT bits. */
static INLINE size_t BmByteCount(IN size_t BitCount)
{
...
*/
static INLINE ElementType BmLastMask(const PBITMAP bitmap)
{
