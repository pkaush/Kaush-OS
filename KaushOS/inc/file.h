...
#define FILE_WRITE_EA                                                                                                  \
    0x20 // Change the file's extended attributes (EAs). This flag is irrelevant for device and intermediate drivers.
#define FILE_APPEND_DATA 0x40 // Append data to the file.
#define FILE_EXECUTE                                                                                                   \
    0x80 // Use system paging I/O to read data from the file into memory. This flag is irrelevant for device and
