...
typedef KSTATUS OBJECT_METHODS(IN PVOID Object);

typedef OBJECT_METHODS *POBJECT_METHODS;

// list of the objects from Object type
typedef LIST_HEAD(Object_Type_List, _OBJECT_HEADER) OBJECT_TYPE_LIST, *POBJECT_TYPE_LIST;
...
FORCEINLINE
BOOL ObIsValidObject(IN PVOID Object)
{
...
FORCEINLINE
BOOL ObIsDirectoryObject(IN PVOID Object)
{
...
FORCEINLINE
BOOL ObIsMountpointObject(IN PVOID Object)
{
    POBJECT_HEADER ObjectHeader = (POBJECT_HEADER)OBJECT_TO_OBJECT_HEADER(Object);
    ASSERT(ObIsValidObject(Object));
    ASSERT(ObDirectoryObjectType);
...
FORCEINLINE
BOOL ObIsSymbolicLinkObject(IN PVOID Object)
{
    POBJECT_HEADER ObjectHeader = (POBJECT_HEADER)OBJECT_TO_OBJECT_HEADER(Object);
    ASSERT(ObIsValidObject(Object));
...
FORCEINLINE
BOOL ObIsDeviceObject(IN PVOID Object)
{
    POBJECT_HEADER ObjectHeader = (POBJECT_HEADER)OBJECT_TO_OBJECT_HEADER(Object);
    ASSERT(ObIsValidObject(Object));
...
FORCEINLINE
VOID ObInitializeLookupContext(POBP_LOOKUP_CONTEXT Context)
{
...
FORCEINLINE
VOID ObpFreeObjectNameBuffer(IN PUNICODE_STRING ObjectName)
{
...
FORCEINLINE
KSTATUS
ObpAllocateObjectPathNameBuffer(IN ULONG Length, IN BOOLEAN UseLookaside, IN OUT PUNICODE_STRING ObjectName)

{
    ...
    ObjectName->Buffer = ExAllocatePoolWithTag(NonPagedPool, MAX_OBJECT_PATH, 'hPbO');
...
FORCEINLINE
VOID ObpFreeObjectPathNameBuffer(IN PUNICODE_STRING ObjectName)
{
