...
static VOID INLINE KiInitWaitBlock(IN OUT PKWAIT_BLOCK WaitBlock, IN PVOID Object)
{
...
VOID KeInitDispatcherHeader(IN PDISPATCHER_HEADER Dispatcher, IN KOBJECTS Type, IN ULONG SignalState)
/*
...
static VOID INLINE KiDHeaderAcquire(IN PDISPATCHER_HEADER Dispatcher)
{
    ...
    else
    {
        ...
        */
        ...
        if ((EventSynchronizationObject) || (MutantObject) || (QueueObject) || (TimerSynchronizationObject) ||
            (SemaphoreObject))
        {
...
static BOOL INLINE KiDHeaderTryAcquire(IN PDISPATCHER_HEADER Dispatcher)
...
static VOID INLINE KiDHeaderRelease(IN PDISPATCHER_HEADER Dispatcher)
{
