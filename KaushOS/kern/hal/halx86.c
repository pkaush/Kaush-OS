...
INLINE BOOL HalDisableInterrupts()
{
    BOOL intstate;
...
INLINE BOOL HalEnableInterrupts()
{
    BOOL intstate;
    intstate = HalAreInterruptsEnabled();
    sti();
