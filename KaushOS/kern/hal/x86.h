...
{
    __asm __volatile("cld\n\trepne\n\tinsb" : "=D"(addr), "=c"(cnt) : "d"(port), "0"(addr), "1"(cnt) : "memory", "cc");
}
...
static __inline ULONG inl(int port)
{
    ULONG data;
...
{
    __asm __volatile("cld\n\trepne\n\toutsl" : "=S"(addr), "=c"(cnt) : "d"(port), "0"(addr), "1"(cnt) : "cc");
}

static __inline void outl(int port, ULONG data)
{
...
static __inline void lcr0(ULONG val)
{
    __asm __volatile("movl %0,%%cr0" : : "r"(val));
}

static __inline ULONG rcr0(void)
{
    ULONG val;
...
static __inline ULONG rcr2(void)
{
    ULONG val;
...
static __inline void lcr4(ULONG val)
{
    __asm __volatile("movl %0,%%cr4" : : "r"(val));
}

static __inline ULONG rcr4(void)
{
    ULONG cr4;
...
static __inline ULONG read_eflags(void)
{
    ULONG eflags;
...
static __inline void write_eflags(ULONG eflags)
{
    __asm __volatile("pushl %0; popfl" : : "r"(eflags));
}

static __inline ULONG read_ebp(void)
{
    ULONG ebp;
...
static __inline ULONG read_esp(void)
{
    ULONG esp;
...
#define MMPAGETABLEAREA_END (MMPAGETABLEAREA_START + MMPAGETABLEAREA_SIZE)
